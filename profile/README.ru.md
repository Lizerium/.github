...
<p align="center">
  Экосистема инструментов и систем для работы с <strong>Freelancer (2003)</strong> и связанными runtime и серверными решениями
</p>
...
**Lizerium** — это набор инструментов, библиотек и серверных компонентов, которые я разрабатываю вокруг игры **Freelancer (2003)**.

Цель — не просто моддинг, а создание понятной и управляемой среды для:

- анализа и реверса игры
- работы с игровыми форматами
- разработки серверов и сервисов
- постепенного переноса и расширения логики (включая Unity)
...
> [!NOTE]  
> В этой организации смешаны разные типы проектов:
>
> - часть написана мной с нуля
> - часть переработана и расширена
> - часть интегрирует существующие решения
>
> Подробности указаны в README каждого репозитория.
...
- [`LizeriumUTFtoXML`](https://github.com/Lizerium/LizeriumUTFtoXML)
  - Соавторы: [`adoxa` | `Jason Hood`](https://adoxa.altervista.org/freelancer/index.html). [Полный список.](https://github.com/Lizerium/LizeriumUTFtoXML/blob/main/CREDITS.md)
- [`LizeriumXMLtoUTF`](https://github.com/Lizerium/LizeriumXMLtoUTF)
  - Соавторы: [`adoxa` | `Jason Hood`](https://adoxa.altervista.org/freelancer/index.html). [Полный список.](https://github.com/Lizerium/LizeriumXMLtoUTF/blob/main/CREDITS.md)
...
- [`Lizerium.FLModStudio`](https://github.com/Lizerium/Lizerium.FLModStudio)
  - Соавторы: [stfx](https://github.com/DomGries) - 2009-2013, [Freelancer Aftermath](https://github.com/AftermathFreelancer) - 2019-2020, [Lazrius](https://github.com/Lazrius) - 2020

---

## Что внутри

- форматы Freelancer (`UTF`, `XML`, ресурсы)
- инструменты анализа и изменения данных
- серверные компоненты и API
- runtime-эксперименты и интеграции
- Unity-направление (в разработке)

---

## Зачем это делается

- сохранить структуру при росте проекта
- разделить ответственность между компонентами
- упростить разработку сложных систем
- подготовить основу для более крупных решений
...
> [!TIP]  
> Это не архив и не сборка чужого кода.
>
> Это моя рабочая среда, в которой я:
>
> - исследую Freelancer
> - пишу инструменты
> - строю архитектуру
> - развиваю систему дальше
